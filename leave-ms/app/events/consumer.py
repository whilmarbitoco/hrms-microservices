...
QUEUE = "leave_queue"
DLQ = "leave_dlq"
BINDINGS = ["employee.created", "employee.terminated", "employee.rehired"]
...
def _dispatch(routing_key, data):
    from app.events.handlers import handle_employee_created, handle_employee_terminated, handle_employee_rehired
    handlers = {
...
def _run(app):
    ...
    while True:
        try:
            ...
            retries = 0
            logger.info("LMS consumer started")
