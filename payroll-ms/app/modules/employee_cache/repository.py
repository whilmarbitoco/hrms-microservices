...
class EmployeeCacheRepository:
    ...
    def upsert(self, employee_id, name, department, role, status):
        ...
        if record:
            ...
            record = EmployeeCache(employee_id=employee_id, name=name, department=department, role=role, status=status)
