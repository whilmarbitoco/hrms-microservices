...
from app.routes.v1.salary_components import salary_components_bp
from app.routes.v1.adjustments import adjustments_bp
from app.routes.v1.payroll_batches import payroll_batches_bp
from app.routes.v1.payslips import payslips_bp
...
def create_app():
    ...
    app.register_blueprint(payroll_batches_bp)
